...
export const ENEMIES = Object.freeze({
  ...
  crusher: freezeEnemy({
    ...
    attackDamage: 78, attackCooldownTicks: 108, attackWindupTicks: 34,
    attackTargets: Object.freeze(['frontline']),
  }),
  'mossback-brute': freezeEnemy({
    id: 'mossback-brute', health: 1100, speed: 25, bounty: 190, armor: 0.20, cooldownTicks: 600, castleDamage: 2,
    attackDamage: 102, attackCooldownTicks: 102, attackWindupTicks: 36,
    attackTargets: Object.freeze(['frontline']),
  ...
  'dread-colossus': freezeEnemy({
    ...
    attackDamage: 160, attackCooldownTicks: 114, attackWindupTicks: 40,
    attackTargets: Object.freeze(['frontline']),
