...
const PAD_CELL_IDS = Object.freeze({
  ...
  7: ['r2c2', 'r0c4', 'r4c4', 'r1c7', 'r6c8', 'r4c0', 'r8c3', 'r5c7'],
  8: ['r2c4', 'r0c3', 'r4c4', 'r1c6', 'r6c6', 'r3c1', 'r8c5', 'r3c3'],
  9: ['r2c3', 'r0c2', 'r5c6', 'r3c6', 'r8c3', 'r4c2', 'r10c8', 'r5c5'],
  10: ['r2c6', 'r0c3', 'r5c4', 'r1c7', 'r8c8', 'r4c0', 'r9c1', 'r5c7'],
});
...
export const LEVELS = freeze([
  ...
  level({
    id: 'level-7', name: "Warlord's March", waveCount: 6, healthScale: 1.42, bountyCoinCap: 550, threatIndex: 430,
    waves: [
      [spawn('swarmkin', 24, 30, 0)],
      [spawn('hexcaller', 4, 114, 0), spawn('skitter', 16, 54, 72)],
      [spawn('crusher', 4, 156, 0), spawn('shellguard', 6, 90, 96)],
      [spawn('swarmkin', 28, 30, 0)],
      [spawn('shellguard', 10, 84, 0), spawn('hexcaller', 4, 108, 108)],
      [
        spawn('ironhide-warlord', 1, 0, 0),
        spawn('shellguard', 12, 72, 120),
        spawn('crusher', 8, 102, 180),
        spawn('skitter', 32, 30, 120),
        spawn('skitter', 12, 36, 15000),
      ],
    ],
    silverScore: 1050, goldScore: 1360, parSeconds: 360,
  }),
  level({
    id: 'level-8', name: 'Fogbound Siege', waveCount: 6, healthScale: 1.58, threatIndex: 525,
    waves: [
  ...
  level({
    id: 'level-9', name: 'The Last Green', waveCount: 7, healthScale: 1.68, threatIndex: 640,
    waves: [
      [spawn('crusher', 5, 144, 0), spawn('shellguard', 8, 78, 96)],
      [spawn('hexcaller', 5, 102, 0), spawn('swarmkin', 20, 32, 84)],
      [spawn('skitter', 14, 48, 0), spawn('crusher', 4, 138, 90)],
      [spawn('shellguard', 12, 72, 0), spawn('hexcaller', 5, 96, 90)],
      [spawn('swarmkin', 24, 30, 0), spawn('skitter', 14, 46, 72)],
      [spawn('crusher', 6, 132, 0), spawn('shellguard', 10, 72, 108)],
      [spawn('hexcaller', 6, 96, 0), spawn('swarmkin', 26, 30, 96)],
    ],
    silverScore: 1540, goldScore: 1980, parSeconds: 420,
  }),
  level({
    id: 'level-10', name: "Champion's Stand", waveCount: 8, healthScale: 1.78, bountyCoinCap: 580, threatIndex: 800,
    waves: [
      [
        spawn('crusher', 3, 96, 0),
        spawn('swarmkin', 24, 32, 0),
        spawn('shellguard', 4, 84, 120),
      ],
      [spawn('swarmkin', 24, 32, 0), spawn('skitter', 12, 48, 72)],
      [spawn('crusher', 3, 138, 0), spawn('shellguard', 8, 78, 90)],
      [spawn('hexcaller', 4, 96, 0), spawn('swarmkin', 22, 32, 96)],
      [spawn('skitter', 16, 46, 0), spawn('crusher', 3, 132, 90)],
      [spawn('shellguard', 10, 72, 0), spawn('hexcaller', 4, 96, 108)],
      [spawn('swarmkin', 26, 30, 0), spawn('crusher', 2, 132, 90)],
      [
        spawn('dread-colossus', 1, 0, 0),
        spawn('swarmkin', 16, 34, 120),
        spawn('skitter', 32, 30, 120),
        spawn('skitter', 16, 36, 15000),
        spawn('skitter', 32, 28, 22000),
        spawn('shellguard', 12, 54, 120),
        spawn('crusher', 3, 102, 180),
        spawn('hexcaller', 4, 102, 240),
      ],
    ],
